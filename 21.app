...
.head 7 -  Call AddField('Aufnadfdfdfegrund', 4, '', FALSE, '', '', FALSE)
.head 7 -  Call AddField('Aufnahmegewicht', 5, '', FALSE, '', '', FALSE)
.head 7 -  ! Call AddField('Entladfdfdatum', 12, 'yyyyMMddhhhhmm', TRUE, '', 'Entlassdatum is empty!', FALSE)
...
.head 7 -  Call AddField('AltedfdfdfAufnahmetag', 3, '', FALSE, '', '', FALSE)
.head 7 -  Call AddField('Berlaubungstage', 3, '', FALSE, '', '', FALSE)
.head 7 -  Call AddField('Patienddfdfdf', 15, '', FALSE, '', '', FALSE)
